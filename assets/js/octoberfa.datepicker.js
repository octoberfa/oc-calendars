...
+(function ($) {
    ...
    DatePicker.prototype.initDatePicker = function () {
        ...
        if (this.options.minDate) {
            pickerOptions.minDate = new Date(this.options.minDate);
        }

        if (this.options.maxDate) {
            pickerOptions.maxDate = new Date(this.options.maxDate);
        }
    ...
    DatePicker.prototype.initRegion = function () {
        ...
        this.calendarType = $('meta[name="backend-calendar-type"]').attr(
            "content"
        );
        ...
        if (
            !this.calendarLang &&
            $.calendarsPicker.regionalOptions[this.locale]
        ) {
